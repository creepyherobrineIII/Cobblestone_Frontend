    ...
    if(limitedLibraryCatalogue !== null && limitedLibraryCatalogue !== undefined){
        ...
        limitedLibraryCatalogue.forEach(book => {
            ...
            bookItem.innerHTML = `<div class="card position-relative p-4 border rounded-3">
                        <a href="manage-book.html?isbn=${book.ISBN}"><img src="${book.picture}" class="img-fluid shadow-sm" alt="${book.bookTitle}"></a>
                        <h6 class="mt-4 mb-0 fw-bold"><a href="manage-book.htmlhtml/?isbn=${book.ISBN}">${book.bookTitle}</a></h6>
